...
<!-- add login style sheet-->
    ...
    <div class="container">
        <div class="card card-container">
            <img id="profile-img" class="profile-img-card" src="<?php echo $urllogo; ?>" />
            ...
            <form class="form-signin" id="login" name="login" method="post" action="<?php echo $php_self; ?>">
                ...
                <input type="text" id="username" name="username" class="form-control" placeholder="<?php echo $langs->trans('Login'); ?>" required autofocus>
                <input type="password" id="password" name="password"  class="form-control" placeholder="<?php echo $langs->trans('Password'); ?>" required>
                
                <div id="remember" class="checkbox">

                </div>

                <button class="btn btn-lg btn-success btn-block btn-signin" type="submit"><?php echo $langs->trans('Connection'); ?></button>
