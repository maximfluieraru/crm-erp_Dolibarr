...
//  next line was added after installation (resolve some issues of style for login page if user is not connected)
// can generet somme issues when we will search for dolibarr's updates
